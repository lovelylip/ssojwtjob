...
describe('Component Tests', () => {
  describe('Upload Management Detail Component', () => {
    ...
    const route = ({ data: of({ upload: new Upload('9fec3727-3421-4967-b213-ba36557ca194') }) } as any) as ActivatedRoute;
    ...
    describe('OnInit', () => {
      it('Should load upload on init', () => {
        ...
        // THEN
        expect(comp.upload).toEqual(jasmine.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
      });
    });
